...
from .views import (CategoriesViewSet, CommentsViewSet, GenreViewSet, ReviewsViewSet,
...
api_router_v1.register(r'titles/(?P<title_id>\d+)/reviews', ReviewsViewSet, basename='reviews')
api_router_v1.register(r'titles/(?P<title_id>\d+)/reviews/(?P<review_id>\d+)/comments', CommentsViewSet, basename='comments')
api_router_v1.register('users', UserViewSet, basename='users')
api_router_v1.register('users/me', UserViewSet, basename='user')
